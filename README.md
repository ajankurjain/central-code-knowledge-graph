...
[![PyPI](https://img.shields.io/pypi/v/central-code-knowledge-graph?label=pypi&color=2563eb&cacheSeconds=60)](https://pypi.org/project/central-code-knowledge-graph/)
...
# {"ready":true,"checks":{"neo4j":true,"postgres":true,"redis":true},"version":"0.1.4"}
```
...
Current: **v0.1.4** on [PyPI](https://pypi.org/project/central-code-knowledge-graph/) ·
